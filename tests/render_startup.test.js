...
test('Render yarn start boots, serves frontend and API without leaking private files', async () => {
  ...
  try {
    ...
    assert.match(html, /EXPECTED_ENGINE_VERSION = '2026-09-23-gsheet-dual-v14-paired-packed'/);
    ...
    assert.equal(body.engine_version, '2026-09-23-gsheet-dual-v14-paired-packed');
